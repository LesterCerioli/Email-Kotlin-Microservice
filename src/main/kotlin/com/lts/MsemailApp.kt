...
import com.lts.config.ApplicationProperties
import com.lts.config.CRLFLogConverter
...
class MsemailApp(private val env: Environment) {
    ...
    companion object {
        ...
        fun main(args: Array<String>) {
            val env = runApplication<MsemailApp>(*args) { DefaultProfileUtil.addDefaultProfile(this) }.environment
            logApplicationStartup(env)
        }

        @JvmStatic
        private fun logApplicationStartup(env: Environment) {
            val log = LoggerFactory.getLogger(MsemailApp::class.java)
